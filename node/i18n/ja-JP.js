module.exports = {
  ...
  'auth.presetPrefixPath': 'プリセットOSSパス',
  'auth.presetPrefixPath.placeholder': 'オプション, フォーマット: kodo://bucket/key/',
  ...
  'auth.presetPrefixPath.popup.msg1': '大きな特権アカウントのログイン：現在使用されているAKには、すべてのバケットのアクセス許可に「デフォルトのOSSパス」を設定する必要はありません。',
  'auth.presetPrefixPath.popup.msg2': '小さなパーミッションのサブアカウントのログイン：現在のAKのみの使用バケットまたはバケットのパス権限では、 「デフォルトのOSSパス」を設定する必要があります',
