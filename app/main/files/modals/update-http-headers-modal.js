angular.module('web')
  .controller('updateHttpHeadersModalCtrl', ['$scope', '$q','$translate', '$uibModalInstance', 'item', 'currentInfo', 's3Client', 'Toast','safeApply',
    function ($scope, $q, $translate, $modalInstance, item, currentInfo, s3Client, Toast ,safeApply) {
      ...
      function init(){
        ...
        s3Client.getMeta(currentInfo.region, currentInfo.bucket, item.path).then(function(result){
      ...
      function onSubmit(form1){
        ...
        s3Client.setMeta(currentInfo.region, currentInfo.bucket, item.path, headers, metas).then(function(result){
