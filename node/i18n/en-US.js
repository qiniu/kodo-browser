module.exports = {
  ...
  'auth.presetPrefixPath': 'Preset Path Prefix',
  'auth.presetPrefixPath.placeholder': 'Optional, format: kodo://bucket/key/',
  ...
  'auth.presetPrefixPath.popup.msg1': 'The current AK that has all Bucket rights does not need to set the "Preset OSS Path"',
  'auth.presetPrefixPath.popup.msg2': 'The current AK only has the permissions of a Bucket or a certain path under a Bucket, you need to set the "Preset OSS Path"',
