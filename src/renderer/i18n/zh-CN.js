export default {
  ...
  "getDownloadLink.warning.archive": "归档存储文件，只有解冻状态时才能访问",
  "getDownloadLink.warning.deepArchive": "深度归档存储文件，只有解冻状态时才能访问",
  ...
  restore: "解冻",
  "restore.checker.hint.archive.needUnfreeze": "归档文件，需要解冻才能预览或下载。",
  "restore.checker.hint.archive.unfreezing": "归档文件正在解冻中，请耐心等待...",
  "restore.checker.hint.archive.unfrozen": "归档文件已解冻",
  "restore.checker.hint.deepArchive.needUnfreeze": "深度归档文件，需要解冻才能预览或下载。",
  "restore.checker.hint.deepArchive.unfreezing": "深度归档文件正在解冻中，请耐心等待...",
  "restore.checker.hint.deepArchive.unfrozen": "深度归档文件已解冻",
  "restore.checker.unfreezeButton": "立即解冻",
  "restore.on": "提交中...",
  ...
  "restore.message.archive.unfreezing": "归档存储文件正在解冻中",
  "restore.message.archive.unfrozen": "归档存储文件已解冻",
  "restore.message.archive.headError": "获取归档存储文件状态失败",
  "restore.message.deepArchive.unfreezing": "深度归档存储文件正在解冻中",
  "restore.message.deepArchive.unfrozen": "深度归档存储文件已解冻",
  "restore.message.deepArchive.headError": "获取深度归档存储文件状态失败",
  ...
  "updateStorageClassModal.message.archive.frozen": "归档存储文件，要解冻后才支持修改存储类型",
  "updateStorageClassModal.message.archive.unfreezing": "归档存储文件正在解冻中，要解冻后才支持修改存储类型",
  "updateStorageClassModal.message.archive.headError": "获取归档存储文件状态失败",
  "updateStorageClassModal.message.deepArchive.frozen": "深度归档存储文件，要解冻后才支持修改存储类型",
  "updateStorageClassModal.message.deepArchive.unfreezing": "深度归档存储文件正在解冻中，要解冻后才支持修改存储类型",
