...
// https://github.com/codemirror/codemirror5/blob/7f488eb5c12d71ea7ea75e286b7b9c029453a298/mode/meta.js
...
export function getFileType(item: Item): FileTypeInfo {
  ...
  const codeMode = modeInfo.find(m =>
    m.ext?.some(e => e === ext)
  );
...
export function getFileIconClassName(item: Item) {
