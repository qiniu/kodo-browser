export default {
  ...
  "getDownloadLink.warning.archive": "An archived storage file can only be accessed when they are restored",
  "getDownloadLink.warning.deepArchive": "A deep archived storage file can only be accessed when they are restored",
  ...
  restore: "Restore",
  "restore.checker.hint.archive.needUnfreeze": "Archive need to be restored in order to preview or download.",
  "restore.checker.hint.archive.unfreezing": "Archive file is recovering, please be patient ...",
  "restore.checker.hint.archive.unfrozen": "The archive has been restored",
  "restore.checker.hint.deepArchive.needUnfreeze": "Deep archive need to be restored in order to preview or download.",
  "restore.checker.hint.deepArchive.unfreezing": "Deep Archive file is recovering, please be patient ...",
  "restore.checker.hint.deepArchive.unfrozen": "The deep archive has been restored",
  "restore.unfreezeButton": "Restore immediately",
  "restore.on": "Sending...",
  ...
  "restore.message.archive.unfreezing": "Archived storage file is being unfreezing",
  "restore.message.archive.unfrozen": "Archived storage file has been unfrozen",
  "restore.message.archive.head_error": "Failed to get status of the archived storage file",
  "restore.message.deepArchive.unfreezing": "Deep archived storage file is being unfreezing",
  "restore.message.deepArchive.unfrozen": "Deep archived storage file has been unfrozen",
  "restore.message.deepArchive.headError": "Failed to get status of the deep archived storage file",
  ...
  "updateStorageClassModal.message.archive.frozen": "Archived storage file only supports modification of storage type after being unfrozen",
  "updateStorageClassModal.message.archive.unfreezing": "Archived storage file is being unfreezing, it only supports modification of storage type after being unfrozen",
  "updateStorageClassModal.message.archive.headError": "Failed to get status of the archived storage file",
  "updateStorageClassModal.message.deepArchive.frozen": "Deep archived storage file only supports modification of storage type after being unfrozen",
  "updateStorageClassModal.message.deepArchive.unfreezing": "Deep archived storage file is being unfreezing, it only supports modification of storage type after being unfrozen",
  "updateStorageClassModal.message.deepArchive.headError": "Failed to get status of the deep archived storage file",
