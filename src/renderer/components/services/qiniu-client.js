import { Qiniu, Region, KODO_MODE, S3_MODE, RegionService } from 'kodo-s3-adapter-sdk'
...
const QINIU_CLIENT_FACTORY_NAME = 'QiniuClient'

webModule.factory(QINIU_CLIENT_FACTORY_NAME, [
  '$q',
  '$rootScope',
  '$translate',
  '$timeout',
  ...
  function ($q, $rootScope, $translate, $timeout, $state, Toast, Config, AuthInfo, settingsSvs) {
    ...
    function saveContent(region, bucket, key, content, domain, getOpt, putOpt) {
      return new Promise((resolve, reject) => {
        getDefaultClient(putOpt).enter('saveContent', (client) => {
...
export default QINIU_CLIENT_FACTORY_NAME
