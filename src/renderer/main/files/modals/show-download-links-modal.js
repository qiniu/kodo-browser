...
const SHOW_DOWNLOAD_LINKS_MODAL_CONTROLLER_NAME = 'showDownloadLinksModalCtrl'

webModule
  .controller(SHOW_DOWNLOAD_LINKS_MODAL_CONTROLLER_NAME, [
    '$scope',
    '$timeout',
    '$translate',
    '$uibModalInstance',
...
export default SHOW_DOWNLOAD_LINKS_MODAL_CONTROLLER_NAME
