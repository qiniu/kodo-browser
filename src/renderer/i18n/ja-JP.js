export default {
  ...
  "getDownloadLink.warning.archive": "アーカイブされたストレージファイルは、復元されたときにのみアクセスできます",
  "getDownloadLink.warning.deepArchive": "ディープアーカイブストレージファイルは、復元された場合にのみアクセスできます",
  ...
  restore: "リストア",
  "restore.checker.hint.archive.needUnfreeze": "プレビューまたはダウンロードするためにアーカイブを復元する必要があります。",
  "restore.checker.hint.archive.unfreezing": "アーカイブファイルが回復しています、しばらくお待ちください ...",
  "restore.checker.hint.archive.unfrozen": "アーカイブが復元されました",
  "restore.checker.hint.deepArchive.needUnfreeze": "プレビューまたはダウンロードするには、ディープアーカイブを復元する必要があります。",
  "restore.checker.hint.deepArchive.unfreezing": "ディープアーカイブファイルが回復しています。しばらくお待ちください...",
  "restore.checker.hint.deepArchive.unfrozen": "ディープアーカイブが復元されました",
  "restore.checker.unfreezeButton": "すぐに復元する",
  "restore.on": "送信...",
  ...
  "restore.message.archive.unfreezing": "アーカイブされたストレージファイルを復元しています",
  "restore.message.archive.unfrozen": "アーカイブされたストレージファイルが復元されました",
  "restore.message.archive.headError": "アーカイブされたストレージファイルのステータスを取得できませんでした",
  "restore.message.deepArchive.unfreezing": "ディープアーカイブストレージファイルが復元されています",
  "restore.message.deepArchive.unfrozen": "ディープアーカイブストレージファイルが復元されました",
  "restore.message.deepArchive.headError": "ディープアーカイブストレージファイルのステータスを取得できませんでした",
  ...
  "updateStorageClassModal.message.archive.frozen": "アーカイブされたストレージファイルは、解凍後のストレージタイプの変更のみをサポートします",
  "updateStorageClassModal.message.archive.unfreezing": "アーカイブされたストレージファイルはフリーズ解除されており、フリーズ解除後のストレージタイプの変更のみをサポートしています",
  "updateStorageClassModal.message.archive.headError": "アーカイブされたストレージファイルのステータスを取得できませんでした",
  "updateStorageClassModal.message.deepArchive.frozen": "ディープアーカイブストレージファイルは、復元後のストレージタイプの変更のみをサポートします",
  "updateStorageClassModal.message.deepArchive.unfreezing": "ディープアーカイブされたストレージファイルはフリーズ解除されており、フリーズ解除後のストレージタイプの変更のみをサポートしています",
