angular.module('web')
  .factory('Const', [function () {
    ...
    return {
      ...
      regions: [
        { id: 'cn-east-1', label: '华东 1', storageClasses: getStorageClasses(2) },
        { id: 'cn-north-1', label: '华北 1', storageClasses: getStorageClasses(2) },
        { id: 'cn-south-1', label: '华南 1', storageClasses: getStorageClasses(2) }
      ],
